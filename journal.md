...
Activities completed: measured finger joints and figured out total length.

Problems encountered: Measured my finger while flexed costed me time in fixing my mistake as it significantly increased the length of the joints.
...
Activities completed: Completed thumb and index finger
...
<img width="85" height="279" alt="Screenshot 2026-07-12 11 08 09 PM" src="https://github.com/user-attachments/assets/915c20b4-ec05-4b34-93e7-346e9602384c" />
<img width="409" height="441" alt="Screenshot 2026-07-12 11 13 21 PM" src="https://github.com/user-attachments/assets/844f56c6-54a7-4324-90c7-455691464fb0" />
...
Problems encountered: the last thumb is 14.99 mm in length because our lengths were  not proportionate. Also I had  some problems with filleting the sides, so instead of using "width", set fillet to radius mode instead.
